...
Open **Raycast Settings** > **Extensions** > **Stealth AI** and set:
...
- The **Local Server URL** field accepts any common shape - `localhost:1234`, `http://127.0.0.1:1234/v1/` and `http://localhost:1234` all work.
